import { PluginEventHandler, PluginLoadHandler, PluginMethodHandlers } from './PluginContextHandlers';
import { PluginConfig, PluginState } from './PluginSpec';
export declare type PluginRecord = {
    name: string;
    enabled: boolean;
    ...
    eventHandlers: {
        [eventPath: string]: PluginEventHandler<any, any>[];
    };
};
